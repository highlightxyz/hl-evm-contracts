...
// OpenZeppelin Contracts (last updated v4.7.0) (token/ERC1155/extensions/ERC1155URIStorage.sol)

pragma solidity 0.8.10;

import "./ERC1155AUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "@openzeppelin/contracts-upgradeable/utils/StringsUpgradeable.sol";

/**
 * @title Appending URI storage utilities onto template ERC1155A contract
 * @author highlight.xyz, OpenZeppelin
 * @dev ERC1155 token with storage based token URI management. OpenZeppelin template edited by Highlight
 */
/* solhint-disable */
abstract contract ERC1155AURIStorageUpgradeable is Initializable, ERC1155AUpgradeable {
    /**

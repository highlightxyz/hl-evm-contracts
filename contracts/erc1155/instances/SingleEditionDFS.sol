...
contract SingleEditionDFS is Proxy {
     ...
     * @param implementation_ ERC1155SingleEdition implementation
    ...
    constructor(
        ...
        if (mechanicVectorData.length != 0) {
            ...
            IMechanicMintManager(mintManager).registerMechanicVector(
                IMechanicData.MechanicVectorMetadata(address(this), 0, mechanic, true, false, false),
                seed,
                vectorData
            );
        }

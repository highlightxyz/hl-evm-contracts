...
/**
 * @title Generalized ERC1155 that expects tokenIds to increment in a monotonically increasing sequence
 * @author highlight.xyz
 * @notice Generalized NFT smart contract
 */
contract ERC1155GeneralSequence is MetadataEncryption, ERC1155GeneralSequenceBase {

...
/**
 * @title Generalized Base ERC721 for RazorWorks
 * @author highlight.xyz
 */
abstract contract ERC721RazorWorksBase is ERC721Base, ERC721AURIStorageUpgradeable {
    ...
    function mintAmountToOneRecipient(address recipient, uint256 amount) external virtual onlyMinter nonReentrant {
        uint256 tempSupply = _nextTokenId() - 1; // cach
